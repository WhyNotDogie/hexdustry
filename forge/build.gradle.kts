...
loom {
    forge {
        ...
        mixinConfig(
            "hexdustry-common.mixins.json",
            "hexdustry-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexdustry.apply-datagen-mixin", "true")
                property("hexdustry.$platform-datagen", "true")
            }
        }
    }
}

hexdustryModDependencies {
