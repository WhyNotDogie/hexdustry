...
abstract class HexdustryModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexdustryModDependenciesExtension>("hexdustryModDependencies")
