...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexdustry.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexdustry-common-common-refmap.json
        // fixed:   hexdustry-common.refmap.json
